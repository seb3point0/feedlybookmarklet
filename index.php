...
<head>
	...
	<meta property="og:image" content="http://<?php echo $_SERVER['HTTP_HOST'] ?>/img/feedlybookmarklet.jpg"/>
	...
	<meta name="twitter:image" content="http://<?php echo $_SERVER['HTTP_HOST'] ?>/img/feedlybookmarklet.jpg" />
...
<body>
	...
	<main>
		...
		<section id="social">
			<h4>Be nice, share!</h4>
			<ul>
				<li><a class="facebook" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http://<?php echo $_SERVER['HTTP_HOST'] ?>" onclick="javascript:window.open(this.href, 'facebook-share-dialog', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,width=626,height=436');return false;">Facebook</a></li>
				<li><a class="twitter" target="_blank" href="http://twitter.com/share?url=http://twi.tl/1ecCh5Q&text=Adding RSS subscription to Feedly is easy with this bookmarklet" onclick="javascript:window.open(this.href,'twitter-share-dialog', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=470,width=600');return false;">Twitter</a></li>
				<li><a class="gplus" target="_blank" href="https://plus.google.com/share?url=http://<?php echo $_SERVER['HTTP_HOST'] ?>" onclick="javascript:window.open(this.href,'gplus-share-dialog', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;">Google+</a></li>
	...
	<aside>
		...
		<section>
			...
			<ul>
				...
				<li>Find RSS feeds even when they are not in <code>&lt;head&gt;</code></li>
				<li>Always open Feedly in new tab and not in popup window</li>
			</ul>
		</section>
		<section>
	...
	<script>
	  ...
	  ga('create', 'UA-20785853-2', 'feedlybookmarklet.com');
	  ga('send', 'pageview');	
	</script>
